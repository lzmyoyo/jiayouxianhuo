                ...
                <div>
                    ...
                    <ul style="padding: 0px">
                        ...
                        <li style="padding:10px;" onmouseover="bg(this);" onmouseout="obg(this)">
                            ...
                            <div style="float: left; margin-left:10px; line-height: 20px; width: 400px;">
                                <div><a href="<?php echo $productInfo['orgProductUrl'];?>"><?php echo $productInfo['productName'];?></a></div>
