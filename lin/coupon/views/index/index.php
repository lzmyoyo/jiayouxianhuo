        ...
        <div role="main" id="site-main" class="js-site-main">
            ...
            <div class="container js-page-container " id="search-offer-list">
                <div class="grid-fixed-fluid search-content-grid">
                    <div class="fixed sidebar js-desktop-sidebar-container" style="width:280px">
                        <div class="js-filters" style="position:relative">
                            <div class="js-filter-loading filter-loading-overlay"></div>
                            <div class="js-sidebar-content">
                                <div class="facet-rail">
                                    <div class="js-facet-section facet-section facet-section--counter">
                                        <div class="facet-results-count"><span
                                                    class="js-offer-count offer-count"><?php echo $couponCount; ?></span>
                                            Offers Available
                                        </div>
                                    </div>
                                    <div class="js-facet-section facet-section facet-section--checkboxes"
                                         data-type="di">
                                        ...
                                        <div class="facet-list-container">
                                            <ul class="js-list-overflow-scroll list-overflow-scroll js-facet-list facet-list">
												<?php foreach ($filterList as $filterInfo) { ?>
                                                    <li class="js-facet-filter facet " data-filter="p" data-active="0"
                                                        data-type="discount"
                                                        data-title="<?php echo $filterInfo['name']; ?>">
                                                        <input <?php if (isset($filterInfo['ischeck']) && $filterInfo['ischeck']) {
															echo 'checked';
														} ?> class="input-checkbox" type="checkbox"
                                                             name="discount[]" value="p"><label
                                                                class="input-checkbox-label js-input-toggle-label"
                                                                for="discountp"
                                                                data-url="<?php echo $filterInfo['url']; ?>"><?php echo $filterInfo['name']; ?></label>
                                                    </li>
												<?php } ?>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="js-facet-section facet-section facet-section--checkboxes"
                                         data-type="di">
                                        <div class="h6 js-facet-section-title facet-section-title">Sort by</div>
                                        <div class="facet-list-container">
                                            <ul class="js-list-overflow-scroll list-overflow-scroll js-facet-list facet-list">
												<?php foreach ($sortList as $sortInfo) { ?>
                                                    <li class="js-facet-filter facet " data-filter="p" data-active="0"
                                                        data-type="discount"
                                                        data-title="<?php echo $sortInfo['name']; ?>">
                                                        <input <?php if (isset($sortInfo['ischeck']) && $sortInfo['ischeck']) {
															echo 'checked';
														} ?> class="input-checkbox" type="checkbox"
                                                             name="discount[]" value="p"><label
                                                                class="input-checkbox-label js-input-toggle-label"
                                                                for="discountp"
                                                                data-url="<?php echo $sortInfo['url']; ?>"><?php echo $sortInfo['name']; ?></label>
                                                    </li>
												<?php } ?>
                                            </ul>
                                        </div>
