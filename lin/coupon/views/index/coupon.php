...
<div id="modal" class="modal fade in" style="display: block;">
    <div class="js-modal-inner modal-dialog coupon-modal" id="couponModal">
        <div class="modal-content">
            <div class="modal-header"><span class="modal-close js-close"><svg
                            class="icon icon-close"><use xlink:href="#icon-close"></use></svg></span></div>
            <div class="modal-body">
                <div class="post-click ">
                    <div class="post-click-show-coupon">
                        <div class="offer-redemption-wrapper show-coupon-redemption">
                            <div class="offer-redemption-content">
                                <a href="" style="width:200px" class="offer-merchant-logo js-offer-logo"
                                                                     target="">
                                    <img class="1" src="<?php echo $brandInfo['brandLogo'];?>" > </a>
                                <h3 class="offer-title"> <?php echo $couponItemInfo['couponName'];?> </h3>
                            </div>
                            <div class="offer-redemption-block">
                                <div class="offer-code"><p class="js-code-is-unique hidden">This code is unique to
                                        you and can only be used once.</p>
                                    <p class="offer-tip">Copy and paste this code at <a class="js-merchant-link"
                                                                                        href="<?php echo $brandInfo['siteUrl'];?>"
                                                                                        target="_blank"
                                                                                        rel="nofollow"><?php echo $brandInfo['brandName'];?></a>
                                    </p>
                                    <div class="code-attached-copy">
                                        <div class="button-code js-selectcode"><?php echo $couponItemInfo['couponCode'];?></div>
                                        <button class="button button-primary js-copy" data-clipboard-text="<?php echo $couponItemInfo['couponCode'];?>">Copy</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <section class="offer-redemption-actions js-offer-action-container">
                                    <div class="offer-actions">
                                        ...
                                        <div class="offer-action offer-action-email hide-at-small js-show-email">
                                            ...
                                            <span>Send as Email</span></div>
                                        <div class="offer-action offer-action-text js-show-text">
                                            <svg class="icon icon-phone">
                                                <use xlink:href="#icon-phone"></use>
                                            </svg>
                                            <span>Send as Text</span></div>
                                    </div>
                                    <form class="send-form hidden js-email-form"  style="display: none"><p class="send-form-copy">Email
                                            this deal to your inbox</p>
                                        <div class="send-input-container">
                                            <div class="inline-form-elements"><input class="input js-address"
                                                                                     type="email"
                                                                                     placeholder="Email Address">
                                                <button type="submit"
                                                        class="button button-primary has-spinner js-send-email">
                                                    Send <span class="spinner"></span></button>
                                            </div>
                                            <div class="js-error is-error hidden"></div>
                                        </div>
                                        <div class="notice send-notice">
                                            <small> Your email will only be used to send you this deal. This is not
                                                a subscription service and you will not receive spam.
                                            </small>
                                        </div>
                                    </form>
                                    <form class="send-form js-text-form"  style="display: none"><p class="send-form-copy">Text this
                                            deal to your phone</p>
                                        <div class="send-input-container">
                                            <div class="inline-form-elements"><input type="tel"
                                                                                     class="input js-phone"
                                                                                     placeholder="10-digit Phone Number">
                                                <button type="submit"
                                                        class="button button-primary has-spinner js-send-text"> Send
                                                    <span class="spinner"></span></button>
                                            </div>
                                            <div class="js-error is-error hidden"></div>
                                        </div>
                                        <span class="close js-close"></span></form>
                                </section>
                                <div class="offer-details details description-wrapper js-desc js-toggle"><p
                                            class="offer-details-header">Details : </p>
                                    <p class="offer-details-info js-description-text"><?php echo $couponItemInfo['couponDesc'];?></p></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="modalbg" class="modal-backdrop fade in"></div>
